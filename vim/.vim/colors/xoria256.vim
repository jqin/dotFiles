...
"    echomsg ""
  ...
  if exists("syntax_on")
    ...
    hi Folded       ctermfg=255 guifg=#afafdf ctermbg=60  guibg=#1c1c1c
    ...
    hi Search       ctermfg=0   guifg=#ffffff ctermbg=149 guibg=#577faf            gui=bold
    hi SignColumn   ctermfg=248 guifg=#a8a8a8
    hi SpecialKey   ctermfg=77  guifg=#5fdf5f
    hi StatusLine               guifg=#000000 ctermbg=239 guibg=#afdf87 cterm=bold gui=bold
    ...
    "hi MatchParen   ctermfg=188 guifg=#dfdfdf ctermbg=68  guibg=#5f87df
    "cterm=bold gui=bold
    "hi Number       ctermfg=180 guifg=#dfaf87
    "hi PreProc      ctermfg=150 guifg=#afdf87
    "hi Special      ctermfg=174 guifg=#df8787
    "hi Statement    ctermfg=110 guifg=#87afdf
    "cterm=none gui=none
    ...
    "hi diffDelete   ctermfg=bg  guifg=bg      ctermbg=186 guibg=#dfdf87
    "cterm=none gui=none
    "hi diffDelete   ctermfg=bg  guifg=bg      ctermbg=246 guibg=#949494
    "cterm=none gui=none
    "hi diffChange   ctermfg=bg  guifg=bg      ctermbg=181 guibg=#dfafaf
    "hi diffText     ctermfg=bg  guifg=bg      ctermbg=174 guibg=#df8787
    "cterm=none gui=none
    "
